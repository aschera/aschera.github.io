...
/*  **************************************************************************** */
        ...
        function SignInNowGoogle() {
            ...
            // login button
            document.getElementById('theLoginButtonGoogle').disabled = true;
           ...
           firebase.auth().getRedirectResult().then(function(result) {
            ...
            firebase.auth().onAuthStateChanged(function(user) {
                if (user) {
                    ...
                    document.getElementById('theLoginButtonGoogle').textContent = 'Google';
                    document.getElementById('theLoginButtonGoogle').style.display = 'none';
